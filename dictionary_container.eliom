  ...
  Lwt.return (
    header ~a:[a_class ["os-page-header"]]
      [ a ~a:[a_class ["os-page-header-app-name"]]
          ...
          [ txt Dictionary_base.displayed_app_name ]
          ()
      ; user_box
      ]
  )
...
let%shared os_footer () = Eliom_content.Html.F.(
  footer ~a:[a_class ["os-page-footer"]] [
    p [
      ...
      a ~service:Dictionary_services.os_github_service
        [ txt " Ocsigen Start " ] ();
      txt [%i18n S.footer_eliom_distillery];
      a ~service:Dictionary_services.ocsigen_service
        [ txt " Ocsigen " ] ();
...
let%shared page ?html_a ?a ?title ?head myid_o content =
  ...
  Lwt.return
    (Os_page.content ?html_a ?a ?title ?head
       ...
       ; os_footer ()
       ; Dictionary_drawer.make ?user:me ()
       ])
